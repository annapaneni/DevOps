...
Add-PSSnapin SQLServerProviderSnapin100 
 Invoke-Sqlcmd -InputFile "C:\Support\dbserver\EnterpriseValidate.sql" -ServerInstance "vm-db-ARM2.ilab.midlandls.com" -User-name $username -Password $Password  -QueryTimeout '500'  
} -Credential $cred 
