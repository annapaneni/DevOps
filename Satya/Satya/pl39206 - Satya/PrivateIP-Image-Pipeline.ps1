...
Try
{
    ...
    $nicWebSrv = createNIC -rgName $rgName -Location $location -name $webServerNic -publicIp $null -privateIp $webServerIPAddress -NetworkSecurityGroup $nsg -subnet $vnet.Subnets[1]
